...
#   timestamp: 2024-04-23T16:17:24+00:00
...
class DoiDataArray(RootModel[List[DoiDataObject]]):
    root: List[DoiDataObject]
...
class DoiMetaArray(RootModel[List[DoiMetaObject]]):
