...
def deploy_modal_app(file_contents: str, app_name: str, token_id: str, token_secret: str, env: str):
...
@app.function(image=modal_helper_image)
def remote_deploy_modal_app(file_contents: str, app_name: str, token_id: str, token_secret: str, env: str):
