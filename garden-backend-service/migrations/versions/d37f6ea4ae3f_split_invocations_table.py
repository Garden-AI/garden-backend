...
def upgrade() -> None:
    ...
    # Create sequence for modal_invocation_logs
    op.execute("CREATE SEQUENCE modal_invocation_logs_id_seq")
    ...
    op.create_table(
        ...
        sa.Column(
            ...
            sa.Integer(),
            nullable=False,
            server_default=sa.text("nextval('modal_invocation_logs_id_seq')"),
        ),
...
def downgrade() -> None:
    ...
    # Drop the sequence
    op.execute("DROP SEQUENCE modal_invocation_logs_id_seq")
    # ### end Alembic commands ###
