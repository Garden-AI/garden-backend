...
def upgrade() -> None:
    ...
    op.drop_table('users')
    op.drop_table('tags')
    op.add_column('entrypoints', sa.Column('authors', postgresql.ARRAY(sa.String()), nullable=False))
    op.add_column('entrypoints', sa.Column('tags', postgresql.ARRAY(sa.String()), nullable=False))
    op.add_column('entrypoints', sa.Column('test_functions', postgresql.ARRAY(sa.String()), nullable=False))
    op.alter_column('entrypoints', 'function_text',
...
def downgrade() -> None:
    ...
    sa.ForeignKeyConstraint(['entrypoint_id'], ['entrypoints.id'], name='tags_entrypoint_id_fkey'),
    ...
    sa.ForeignKeyConstraint(['entrypoint_id'], ['entrypoints.id'], name='test_functions_entrypoint_id_fkey'),
    ...
    sa.Column('entrypoint_id', sa.INTEGER(), autoincrement=False, nullable=False),
    sa.ForeignKeyConstraint(['entrypoint_id'], ['entrypoints.id'], name='authors_entrypoint_id_fkey'),
